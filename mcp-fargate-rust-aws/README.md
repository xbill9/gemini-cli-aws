# mcp-fargate-rust-aws

A Rust-based Model Context Protocol (MCP) server designed for deployment on Amazon ECS using **AWS Fargate**, utilizing streaming HTTP.
...
- **Fargate Deployment**: Pre-configured for Amazon ECS AWS Fargate.
