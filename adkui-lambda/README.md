...
- `make deploy`: Automatically saves AWS credentials and deploys to AWS Lambda.
- `make lambda-status`: Checks the current state and status of the Lambda function.
- `make endpoint`: Retrieves the public URL (Function URL) for the deployed Lambda service.
